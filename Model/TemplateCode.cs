using CS2ANGULAR.Model.Serializable;
using System;
...
namespace CS2ANGULAR.Model
{
    public class TemplateCode
    {
        ...
        string GetInterfaceNameEx(CS2ANGULAR.Model.Serializable.DbContextSerializable context, string viewName)
        {
        ...
        string GetInterfacePageNameEx(CS2ANGULAR.Model.Serializable.DbContextSerializable context, string viewName)
        {
            if ((context == null) || string.IsNullOrEmpty(viewName))
            {
                return "I";
        ...
        string GetInterfaceFilterNameEx(CS2ANGULAR.Model.Serializable.DbContextSerializable context, string viewName)
        {
            if ((context == null) || string.IsNullOrEmpty(viewName))
            {
                return "I";
        ...
        string GetCCharpDatatypeEx(CS2ANGULAR.Model.Serializable.ModelViewUIFormPropertySerializable prop, CS2ANGULAR.Model.Serializable.ModelViewSerializable model)
        {
            if ((prop == null) || (model == null)) return "";
        ...
        string GetCCharpDatatypeEx2(CS2ANGULAR.Model.Serializable.ModelViewUIListPropertySerializable prop, CS2ANGULAR.Model.Serializable.ModelViewSerializable model)
        {
            if ((prop == null) || (model == null)) return "";
            ModelViewPropertyOfVwSerializable sclrProp = model.ScalarProperties.Where(p => p.ViewPropertyName == prop.ViewPropertyName).FirstOrDefault();
            return GetCCharpDatatype(sclrProp, model);
        ...
        bool IsPrimaryKeyProperty(CS2ANGULAR.Model.Serializable.ModelViewPropertySerializable prop, CS2ANGULAR.Model.Serializable.ModelViewSerializable model)
        {
        ...
        string GetTypeScriptPropertyNameEx(CS2ANGULAR.Model.Serializable.ModelViewUIFormPropertySerializable prop, CS2ANGULAR.Model.Serializable.ModelViewSerializable model)
        {
            ModelViewPropertyOfVwSerializable sclrProp = model.ScalarProperties.Where(p => p.ViewPropertyName == prop.ViewPropertyName).FirstOrDefault();
        ...
        List<string> GetValidators(CS2ANGULAR.Model.Serializable.ModelViewUIFormPropertySerializable prop, CS2ANGULAR.Model.Serializable.ModelViewSerializable model, Dictionary<string, string> regExps)
        {
        ...
        bool HasCombo(CS2ANGULAR.Model.Serializable.ModelViewUIFormPropertySerializable prop, CS2ANGULAR.Model.Serializable.ModelViewSerializable model)
        {
        ...
        bool HasButton(CS2ANGULAR.Model.Serializable.ModelViewUIFormPropertySerializable prop, CS2ANGULAR.Model.Serializable.ModelViewSerializable model)
        {
        ...
        bool HasTypeahead(CS2ANGULAR.Model.Serializable.ModelViewUIFormPropertySerializable prop, CS2ANGULAR.Model.Serializable.ModelViewSerializable model)
        {
        ...
        bool HasInitMethod(CS2ANGULAR.Model.Serializable.ModelViewUIFormPropertySerializable prop, CS2ANGULAR.Model.Serializable.ModelViewSerializable model)
        {
            return HasCombo(prop, model) || HasButton(prop, model) || HasTypeahead(prop, model);
        }
        bool HasInitMethodForInputMode(CS2ANGULAR.Model.Serializable.ModelViewUIFormPropertySerializable prop, CS2ANGULAR.Model.Serializable.ModelViewSerializable model, int inputType)
        {
            switch (inputType)
            {
                case 1:
        ...
        bool HasModelInitMethodForInputMode(CS2ANGULAR.Model.Serializable.ModelViewSerializable model, int inputType)
        {
            if (model == null)
            {
                return false;
        ...
        string GetExpressionForControlList(CS2ANGULAR.Model.Serializable.ModelViewUIFormPropertySerializable prop, CS2ANGULAR.Model.Serializable.ModelViewSerializable model, string sufix)
        {
            return GetTypeScriptPropertyNameWithSufix(prop, model, sufix) + "Vals";
        }

        string GetExpressionForOnFilterTypeaheadControlListMethod(CS2ANGULAR.Model.Serializable.ModelViewUIFormPropertySerializable prop, CS2ANGULAR.Model.Serializable.ModelViewSerializable model, string typeaheadSufix)
        {
            return "OnFilter" + GetExpressionForControlList(prop, model, typeaheadSufix);
        }
        string GetExpressionForOnUpdateComboControlListMethod(CS2ANGULAR.Model.Serializable.ModelViewUIFormPropertySerializable prop, CS2ANGULAR.Model.Serializable.ModelViewSerializable model, string comboSufix)
        {
            return "OnUpdate" + GetExpressionForControlList(prop, model, comboSufix);
        }
        string GetExpressionForOnValChangedMethod(CS2ANGULAR.Model.Serializable.ModelViewUIFormPropertySerializable prop, CS2ANGULAR.Model.Serializable.ModelViewSerializable model)
        {
            return "OnValChanged" + GetTypeScriptPropertyNameEx(prop, model);
        }
        string GetTypeScriptPropertyNameWithSufixBase(CS2ANGULAR.Model.Serializable.ModelViewPropertyOfVwSerializable prop, CS2ANGULAR.Model.Serializable.ModelViewSerializable model, string sufix)
        {
            return GetTypeScriptPropertyName(prop, model) + sufix;
        }
        string GetTypeScriptPropertyNameWithSufix(CS2ANGULAR.Model.Serializable.ModelViewUIFormPropertySerializable prop, CS2ANGULAR.Model.Serializable.ModelViewSerializable model, string sufix)
        {
            return GetTypeScriptPropertyNameEx(prop, model) + sufix;
        }
        string GetExpressionForOnInitMethod(CS2ANGULAR.Model.Serializable.ModelViewUIFormPropertySerializable prop, CS2ANGULAR.Model.Serializable.ModelViewSerializable model)
        {
            return "OnInit" + GetTypeScriptPropertyNameEx(prop, model);
        }


        List<string> CollectComboListInterfaces(CS2ANGULAR.Model.Serializable.DbContextSerializable context,
                                                CS2ANGULAR.Model.Serializable.ModelViewUIFormPropertySerializable prop,
                                                CS2ANGULAR.Model.Serializable.ModelViewSerializable model)
        {
            List<string> result = new List<string>();
        ...
        List<string> CollectButtonItemInterfaces(CS2ANGULAR.Model.Serializable.DbContextSerializable context,
                                                CS2ANGULAR.Model.Serializable.ModelViewUIFormPropertySerializable prop,
                                                CS2ANGULAR.Model.Serializable.ModelViewSerializable model)
        {
            List<string> result = new List<string>();
        ...
        List<string> CollectTypeaheadListInterfaces(CS2ANGULAR.Model.Serializable.DbContextSerializable context,
                                                CS2ANGULAR.Model.Serializable.ModelViewUIFormPropertySerializable prop,
                                                CS2ANGULAR.Model.Serializable.ModelViewSerializable model)
        {
            List<string> result = new List<string>();
        ...
        string GetFormControlHiddenCondition(CS2ANGULAR.Model.Serializable.ModelViewUIFormPropertySerializable prop, CS2ANGULAR.Model.Serializable.ModelViewSerializable model, string eformModePropName)
        {
        ...
        string GetDisplayAttributeValueString(CS2ANGULAR.Model.Serializable.ModelViewUIFormPropertySerializable prop, CS2ANGULAR.Model.Serializable.ModelViewSerializable model, string propName)
        {
            ModelViewPropertyOfVwSerializable sclrProp = model.ScalarProperties.Where(p => p.ViewPropertyName == prop.ViewPropertyName).FirstOrDefault();
            if (sclrProp == null)
            {
        ...
        bool IsDateInput(CS2ANGULAR.Model.Serializable.ModelViewUIFormPropertySerializable prop, CS2ANGULAR.Model.Serializable.ModelViewSerializable model)
        {
            ModelViewPropertyOfVwSerializable sclrProp = model.ScalarProperties.Where(p => p.ViewPropertyName == prop.ViewPropertyName).FirstOrDefault();
            if (sclrProp == null)
            {
        ...
        string GetComponentClassNameEx(CS2ANGULAR.Model.Serializable.DbContextSerializable context, string viewName, string fileType)
        {
            string result = "";
        ...
        string GetServiceClassNameEx(CS2ANGULAR.Model.Serializable.DbContextSerializable context, string ViewName, string fileType)
        {
        ...
        string GetPrimKeyFilterForFindIndexMethod(CS2ANGULAR.Model.Serializable.DbContextSerializable context, string ViewName, string srcPrefix, string destPrefix)
        {
            if ((context == null) || (string.IsNullOrEmpty(ViewName)))
            {
                return "false";
        ...
        string GetControlListPropertyName(CS2ANGULAR.Model.Serializable.ModelViewUIFormPropertySerializable prop, CS2ANGULAR.Model.Serializable.ModelViewSerializable model, CS2ANGULAR.Model.Serializable.DbContextSerializable context, int inputType)
        {
        ...
        CS2ANGULAR.Model.Serializable.ModelViewSerializable
            GetViewForControlList(CS2ANGULAR.Model.Serializable.ModelViewUIFormPropertySerializable prop, CS2ANGULAR.Model.Serializable.ModelViewSerializable model, CS2ANGULAR.Model.Serializable.DbContextSerializable context, int inputType)
        {
        ...
        string GetViewNameForControlList(CS2ANGULAR.Model.Serializable.ModelViewUIFormPropertySerializable prop, CS2ANGULAR.Model.Serializable.ModelViewSerializable model, CS2ANGULAR.Model.Serializable.DbContextSerializable context, int inputType)
        {
            CS2ANGULAR.Model.Serializable.ModelViewSerializable mv =
        ...
        List<ModelViewPropertyOfVwSerializable> GetPrimaryKeyProps(CS2ANGULAR.Model.Serializable.DbContextSerializable context, string viewName)
        {
            List<ModelViewPropertyOfVwSerializable> result = new List<ModelViewPropertyOfVwSerializable>();
            if ((context == null) || string.IsNullOrEmpty(viewName))
            {
        ...
        List<ModelViewPropertyOfVwSerializable> GetForeignKeyProps(CS2ANGULAR.Model.Serializable.DbContextSerializable context, CS2ANGULAR.Model.Serializable.ModelViewSerializable model,
                                                ModelViewUIFormPropertySerializable masterProp, ModelViewUIFormPropertySerializable detailProp, int inputType)
        {
            ...
            CS2ANGULAR.Model.Serializable.ModelViewSerializable detailModel =
        ...
        List<ModelViewPropertyOfVwSerializable> GetForeignKeyPropsBase(CS2ANGULAR.Model.Serializable.DbContextSerializable context, CS2ANGULAR.Model.Serializable.ModelViewSerializable model,
        ...
        List<string> GetFKViewsList(CS2ANGULAR.Model.Serializable.ModelViewSerializable model,
                                         CS2ANGULAR.Model.Serializable.DbContextSerializable context,
        ...
        List<string> GetSearchDialogViewsList(CS2ANGULAR.Model.Serializable.ModelViewSerializable model,
                                             CS2ANGULAR.Model.Serializable.DbContextSerializable context,
        ...
        List<CS2ANGULAR.Model.Serializable.ModelViewUIFormPropertySerializable>
            GetDirectMasters(CS2ANGULAR.Model.Serializable.ModelViewUIFormPropertySerializable prop,
                             CS2ANGULAR.Model.Serializable.ModelViewSerializable model,
                             CS2ANGULAR.Model.Serializable.DbContextSerializable context, int inputType)
        {
            List<CS2ANGULAR.Model.Serializable.ModelViewUIFormPropertySerializable> result = new List<CS2ANGULAR.Model.Serializable.ModelViewUIFormPropertySerializable>();
            if ((prop == null) || (model == null) || (context == null))
            {
                return result;
            }
        ...
        List<CS2ANGULAR.Model.Serializable.ModelViewUIFormPropertySerializable>
            GetDependentScalarProps(CS2ANGULAR.Model.Serializable.ModelViewUIFormPropertySerializable prop,
                                    CS2ANGULAR.Model.Serializable.ModelViewSerializable model,
                                    CS2ANGULAR.Model.Serializable.DbContextSerializable context, int inputType)
        {
            List<CS2ANGULAR.Model.Serializable.ModelViewUIFormPropertySerializable> result = new List<CS2ANGULAR.Model.Serializable.ModelViewUIFormPropertySerializable>();
            ...
            List<CS2ANGULAR.Model.Serializable.ModelViewUIFormPropertySerializable> masters = GetDirectMasters(prop, model, context, inputType);
        ...
        List<CS2ANGULAR.Model.Serializable.ModelViewUIFormPropertySerializable>
            GetDirectDetails(CS2ANGULAR.Model.Serializable.ModelViewUIFormPropertySerializable prop,
                             CS2ANGULAR.Model.Serializable.ModelViewSerializable model,
                             CS2ANGULAR.Model.Serializable.DbContextSerializable context, int inputType)
        {
            List<CS2ANGULAR.Model.Serializable.ModelViewUIFormPropertySerializable> result = new List<CS2ANGULAR.Model.Serializable.ModelViewUIFormPropertySerializable>();
        ...
        bool MustHaveDirectDetails(CS2ANGULAR.Model.Serializable.ModelViewUIFormPropertySerializable prop,
                             CS2ANGULAR.Model.Serializable.ModelViewSerializable model,
                             CS2ANGULAR.Model.Serializable.DbContextSerializable context)
        {
            bool result = false;
        ...
        List<ModelViewPropertyOfVwSerializable> GetAllForeignKeyProps(CS2ANGULAR.Model.Serializable.ModelViewSerializable model)
        {
            List<ModelViewPropertyOfVwSerializable> result = new List<ModelViewPropertyOfVwSerializable>();
            if (model == null)
            {
        ...
        ModelViewPropertyOfVwSerializable GetOnValChangeViewPropName(CS2ANGULAR.Model.Serializable.DbContextSerializable context, CS2ANGULAR.Model.Serializable.ModelViewSerializable model,
        ...
        bool HasOnValChangedMethod(CS2ANGULAR.Model.Serializable.DbContextSerializable context, CS2ANGULAR.Model.Serializable.ModelViewSerializable model,
